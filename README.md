...
ADeT is a tool for rednut that allows it to compile on different platforms. ADeT allows you to describe assembly languages on different architectures so that one compiler can be used on every architecture. ADeT also allows NinePoint to compile to any platform.
